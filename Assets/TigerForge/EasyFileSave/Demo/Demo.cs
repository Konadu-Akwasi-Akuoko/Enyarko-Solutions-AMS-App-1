...
public class Demo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Name = GameObject.FindWithTag("Name").GetComponent<Text>();
        Age = GameObject.FindWithTag("Age").GetComponent<Text>();
        Strength = GameObject.FindWithTag("Strength").GetComponent<Text>();
    ...
    void Update()
    {
        ...
        if (Input.GetKeyUp(KeyCode.S))
        {
            ...
            Strength.text = strenght.ToString();
    ...
    private void ShowData()
    {
        ...
        */
        ...
        foreach (KeyValuePair<string, int> kvp in coins)
        {
